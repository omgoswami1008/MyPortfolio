...
export const metadata: Metadata = {
  title: "GOSWAMI OMGIRI | Data Scientist ",
  description:
  "Portfolio of Goswami Omgiri, an aspiring Data Scientist and AI/ML Engineer. Showcasing projects in Machine Learning, Data Analysis, Python, SQL, Data Visualization, and Artificial Intelligence with real-world solutions.",
